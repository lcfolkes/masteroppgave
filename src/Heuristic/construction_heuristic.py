...
class ConstructionHeuristic:
    ...
    def _calculate_z(self, first_stage_car_moves, second_stage_car_moves, verbose=False):
        ...
        start_nodes_first_stage = [car_move.start_node for car_move in first_stage_car_moves if isinstance(car_move.end_node, ParkingNode)]
    ...
    def _calculate_cost_deviation_ideal_state(self, z, first_stage_car_moves, second_stage_car_moves, scenario=None, verbose=False):
        ...
        start_nodes_second_stage = [[car_move.start_node.node_id for car_move in scenarios if isinstance(car_move.end_node, ParkingNode)] for scenarios in
                                    second_stage_car_moves]

        end_nodes_second_stage = [[car_move.end_node.node_id for car_move in scenarios if isinstance(car_move.end_node, ParkingNode)] for scenarios in second_stage_car_moves]
