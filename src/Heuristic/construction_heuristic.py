...
class ConstructionHeuristic:
    ...
    def _calculate_z(self, first_stage_car_moves, second_stage_car_moves, verbose=False):
        ...
        for n in self.parking_nodes:
            # Mathias: Såvidt jeg skjønner så er det scenarioer man iterer gjennom her, så jeg endret fra "cm" til
            ...
            # Mathias: Hvorfor må vi gjøre dette?
    ...
    def _calculate_costs_relocation(self, car_moves):
        ...
        #Mathias: Legger vi inn first stage moves for hvert scenario, også er det like i hvert scenario? Må vel det for at denne skal fungere riktig
    ...
    def _get_obj_val_of_car_move(self, first_stage_car_moves: [CarMove] = None,
        ...
        if scenario is None:
            ...
            first_stage_duplicate_for_scenarios = list(np.repeat(first_stage_car_moves, self.num_scenarios))
            cost_relocation = self._calculate_costs_relocation(
                first_stage_duplicate_for_scenarios + second_stage_car_moves)
