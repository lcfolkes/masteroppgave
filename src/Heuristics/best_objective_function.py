...
class ObjectiveFunction:
    ...
    def evaluate(self, added_car_moves: [CarMove] = None, removed_car_moves: [CarMove] = None, scenario: int = None,
        ...
        #obj_før = copy.copy(self._true_objective_value)
        ...
        #obj_etter = copy.copy(self._true_objective_value)

        #if round(obj_før,2) != round(obj_etter,2):
        #    print("added_car_moves", added_car_moves)
        #    print("removed_car_moves", removed_car_moves)
            ...
            for n in nodes_out:
                for s in range(self.num_scenarios):
                    ...
                    if 0 <= self._z[n.node_id - 1][s][0] < self._z[n.node_id - 1][s][1]:
                        ...
                        self._w[n.node_id - 1][s] += 1
                        if 0 < self._w[n.node_id - 1][s] <= n.ideal_state:
                            cost_deviation_counter -= 1
